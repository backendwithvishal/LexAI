...
- [x] 1. Add delete Joi validator schemas
  ...
  - [x]* 1.1 Write property test for invalid ObjectId returns 400 (Property 4)
...
- [x] 2. Implement `deleteAnalysis` service function
  ...
  - [x]* 2.1 Write property test for permanent deletion invariant (Property 1)
  ...
  - [x]* 2.2 Write property test for cache invalidation on delete (Property 2)
  ...
  - [x]* 2.3 Write property test for org isolation (Property 3)
  ...
  - [x]* 2.4 Write unit tests for `deleteAnalysis`
...
- [x] 3. Implement `deleteAnalysesByContract` service function
  ...
  - [x]* 3.1 Write unit tests for `deleteAnalysesByContract`
...
- [x] 5. Add controller handlers for delete operations
  ...
  - [x]* 5.1 Write unit tests for delete controller handlers
...
- [x] 6. Register DELETE routes in the analysis router
  ...
  - [x]* 6.1 Write integration tests for RBAC on delete routes
