 ...
 *   - Token errors (InvalidTokenError, TokenExpiredError — fallback if not caught in auth middleware)
...
export function errorHandler(err, req, res, next) {
    ...
    // Token errors — PASETO (fallback if not caught in auth middleware)
