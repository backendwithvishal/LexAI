...
// ─── Indexes ──────────────────────────────────────────────────────
// ❌ REMOVED: invitationSchema.index({ token: 1 }, { unique: true })
// ✅ REASON:  token already has unique: true on the field definition above.
//             Defining it again via schema.index() creates a duplicate index
//             which causes the Mongoose warning: "Duplicate schema index on {token:1}"
