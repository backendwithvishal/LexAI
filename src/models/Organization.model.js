...
// ─── Indexes ──────────────────────────────────────────────────────
// ❌ REMOVED: organizationSchema.index({ slug: 1 }, { unique: true })
// ✅ REASON:  slug already has unique: true on the field definition above.
//             Defining it again via schema.index() creates a duplicate index
//             which causes the Mongoose warning: "Duplicate schema index on {slug:1}"
